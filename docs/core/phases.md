...
**Done (2026-09-23).** Drivers are descriptors in their own files, collected
from a linker section; the registry routes, probes, hands out interrupt vectors,
dispatches interrupts, serves the input, network, block and display classes, and
