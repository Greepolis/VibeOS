...
| System Call Interface | In Progress (ring-3 Linux-ABI subset verified) | [system_call_interface.md](implementation_progress/system_call_interface.md) |
...
| User Space Interface | In Progress (ring-3 shell runtime verified) | [user_space_interface.md](implementation_progress/user_space_interface.md) |
