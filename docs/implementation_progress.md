...
| Virtual Memory | In Progress (hardware paging, per-process isolation, copy-on-write fork, and TLB shootdown across cores verified) | [virtual_memory.md](implementation_progress/virtual_memory.md) |
