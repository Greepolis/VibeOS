...
| M14 threads | Done | clone(CLONE_THREAD), futex wait/wake, tgid/tid and thread exit; four threads share memory under a contended mutex, lose no increment and keep their own thread-locals, gated on every boot |
