...
- The CLI smoke summary also records the furthest BusyBox phase, last serial timestamp, QEMU exit code and failure class, making filesystem stalls such as `ls` actionable in CI.
