...
EXPECTED_UNPRODUCED = {
    ...
    "vibeos_io_stats.volumes_found": "I4b, volumes and probing",
    "vibeos_io_stats.mounts": "I4b, volumes and probing",
    "vibeos_io_stats.probe_rejected": "I4b, volumes and probing",
